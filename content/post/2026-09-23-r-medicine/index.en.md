...
## 
## data:  age by rx
## F = 6.2218, num df = 12, denom df = 12, p-value = 0.003476
...
## 
## data:  age by rx
## t = -0.21443, df = 15.76, p-value = 0.833
...
## agegr        2 1315978  657989   9.647 0.000907 ***
## Residuals   23 1568728   68206                     
## ---
...
## 
## data:  futime by agegr
## Kruskal-Wallis chi-squared = 11.85, df = 2, p-value = 0.002672
```
...
## 
## Fit: aov(formula = futime ~ agegr, data = ov)
## 
## $agegr
##                diff        lwr        upr     p adj
## 50-65-<50 -286.6458  -599.7424   26.45073 0.0770180
## >65-<50   -740.3333 -1162.5127 -318.15401 0.0005994
## >65-50-65 -453.6875  -819.3055  -88.06948 0.0132290
```
...
## 
## data:  clin$bp and clin$biomarker
## t = 2.8052, df = 78, p-value = 0.006345
## alternative hypothesis: true correlation is not equal to 0
## 95 percent confidence interval:
##  0.08892324 0.48985990
## sample estimates:
##       cor 
## 0.3027255
```
...
Table: <span id="tab:unnamed-chunk-12"></span>Table 1: 两名评估者的评分交叉表

|        | Normal| Benign| Suspect| Cancer| Sum|
|:-------|------:|------:|-------:|------:|---:|
|Normal  |     50|      2|       0|      1|  53|
|Benign  |      2|     30|       4|      3|  39|
|Suspect |      0|      0|      20|      1|  21|
...
vcd::Kappa(table1)
##             value     ASE     z   Pr(>|z|)
## Unweighted 0.8030 0.03924 20.47  4.334e-93
## Weighted   0.8334 0.03729 22.35 1.237e-110
```
...
## 
## Call:
## glm(formula = low ~ age + lwt + race + smoke + ptl, family = binomial, 
##     data = birthwt)
## 
## Coefficients:
##              Estimate Std. Error z value Pr(>|z|)  
## (Intercept) -0.257973   1.215459  -0.212   0.8319  
## age         -0.039720   0.034942  -1.137   0.2557  
## lwt         -0.008198   0.006158  -1.331   0.1831  
## race         0.465047   0.207813   2.238   0.0252 *
## smoke        0.933837   0.386154   2.418   0.0156 *
## ptl          0.647772   0.335266   1.932   0.0533 .
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
...
## Residual deviance: 213.17  on 183  degrees of freedom
## AIC: 225.17
## 
...
Table: <span id="tab:unnamed-chunk-15"></span>Table 2: Logistic 回归结果（OR 及其 95% CI）

|            |term        |   beta|    OR| CI_low| CI_high|
|:-----------|:-----------|------:|-----:|------:|-------:|
|(Intercept) |(Intercept) | -0.258| 0.773|  0.071|   8.367|
|age         |age         | -0.040| 0.961|  0.897|   1.029|
|lwt         |lwt         | -0.008| 0.992|  0.980|   1.004|
|race        |race        |  0.465| 1.592|  1.059|   2.393|
|smoke       |smoke       |  0.934| 2.544|  1.194|   5.423|
|ptl         |ptl         |  0.648| 1.911|  0.991|   3.687|
...
<img src="{{< blogdown/postref >}}index.en_files/figure-html/unnamed-chunk-22-1.png" alt="" width="672" />
...
sd_test
## Call:
## survdiff(formula = Surv(futime, fustat) ~ rx, data = ov)
## 
...
## rxB        -4.854e-01  6.155e-01  7.913e-01 -0.613    0.540
## resid.ds2   7.851e-01  2.193e+00  7.560e-01  1.038    0.299
## ecog.ps2   -4.653e-02  9.545e-01  6.471e-01 -0.072    0.943
## agegr50-65  1.488e+00  4.428e+00  1.153e+00  1.291    0.197
## agegr>65    2.270e+01  7.232e+09  9.137e+03  0.002    0.998
## 
##            exp(coef) exp(-coef) lower .95 upper .95
## rxB        6.155e-01  1.625e+00    0.1305     2.903
## resid.ds2  2.193e+00  4.561e-01    0.4983     9.648
## ecog.ps2   9.545e-01  1.048e+00    0.2686     3.393
## agegr50-65 4.428e+00  2.258e-01    0.4626    42.390
## agegr>65   7.232e+09  1.383e-10    0.0000       Inf
## 
## Concordance= 0.782  (se = 0.089 )
## Likelihood ratio test= 22.43  on 5 df,   p=4e-04
## Wald test            = 2.78  on 5 df,   p=0.7
## Score (logrank) test = 38.74  on 5 df,   p=3e-07
```
...
##          chisq df     p
## rx       0.016  1 0.899
## resid.ds 0.602  1 0.438
## ecog.ps  5.511  1 0.019
## agegr    3.676  2 0.159
## GLOBAL   9.690  5 0.085
```
...
Table: <span id="tab:unnamed-chunk-26"></span>Table 3: 诊断试验四格表
...
Table: <span id="tab:unnamed-chunk-27"></span>Table 4: 诊断试验评价指标

|                   | round(diag_metrics, 3)|
|:------------------|----------------------:|
|灵敏度_Sensitivity |                  0.800|
|特异度_Specificity |                  0.900|
|阳性预测值_PPV     |                  0.296|
|阴性预测值_NPV     |                  0.988|
|准确率_Accuracy    |                  0.895|
|阳性似然比_LRpos   |                  8.000|
...
<img src="{{< blogdown/postref >}}index.en_files/figure-html/unnamed-chunk-30-1.png" alt="" width="672" />
